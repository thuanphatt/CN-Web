...
$sql_update_donhang = "UPDATE tbl_donhang SET huydon='$huydon' WHERE mahang='$magiaodich'";
$update_donhang = $con->exec($sql_update_donhang);

$sql_update_giaodich = "UPDATE tbl_giaodich SET huydon='$huydon' WHERE magiaodich='$magiaodich'";
$update_giaodich = $con->exec($sql_update_giaodich);
?>
<!-- top Products -->
                ...
                <div class="wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            $sql_select =  "SELECT * FROM tbl_giaodich WHERE tbl_giaodich.khachhang_id='$id_khachhang' GROUP BY tbl_giaodich.magiaodich";
                            $select = $con->query($sql_select)->fetchAll(PDO::FETCH_ASSOC);
                            ?>
                        ...
                        <div class="col-md-12">
                            ...
                            $sql_select = "SELECT * FROM tbl_giaodich,tbl_khachhang,tbl_sanpham 
